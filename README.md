...
1) The git repo folder is stored within a locally mounted Google Drive disk. Downsides:  
...
2) The git repo folder is stored on a fast local storage outside of Google Drive, while master Colab notebooks are stored in Google Drive. They are pushed into a single GitHub remote repo separately. Downsides:  
...
3) The git repo folder is stored on a fast local storage outside of Google Drive, while master Colab notebooks are stored in GitHub. Downsides:    
